...
macro(maker_module_depend module_name)
  ...
  if (EXISTS ${MAKER_BASE_PATH}/libs/${module_name})
	...
	_maker_module_add_raw_module_dep(lib_${module_name})
	_maker_module_add_raw_include_dir(${MAKER_BASE_PATH}/libs/${module_name}/include)
  else()
...
macro(_maker_module_add_raw_module_dep raw_module_name)
	set(MAKER_MODULE_DEP_MODULES ${MAKER_MODULE_DEP_MODULES} ${raw_module_name})
endmacro()

macro(_maker_module_add_raw_include_dir raw_include_dir)
